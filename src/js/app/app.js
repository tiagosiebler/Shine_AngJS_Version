(function() {
    angular.module('serverCP', ['routes', 'Data', 'Graphs', 'authCtrl', 'ordersCtrl','navbar','ordersTable','membersCtrl','membersTable','activationsCtrl','activationsTable','logsCtrl','versionsCtrl','graphViewCtrl','reportingCtrl'])
