...
var project 		= 'newcp', // Project name, used for build zip.
	...
	buildProd		= './prod', 	// Production/optimised target, where the zip will be made from
	buildDev		= './dev', 	// Development target, not optised to reduce headaches
...
gulp.task('buildJSVendors', function () {
	return gulp.src([
		...
		.pipe(newer(buildProd + '/js/vendors.js'))
		.pipe(concat('vendors.js'))
		.pipe(ngAnnotate())
		.pipe(uglify())
		.pipe(gulp.dest(buildProd + '/js'))
...
gulp.task('buildJSApp', function () {
	return gulp.src([
		...
		.pipe(sourcemaps.init())
		.pipe(newer(buildProd + '/js/app.js'))
		.pipe(concat('app.js'))
		.pipe(ngAnnotate())
...
gulp.task('buildZip', function () {
	...
	return 	gulp.src(buildProd+'/**/',{dot: true})
...
gulp.task('clean', function() {
 	return 	gulp.src([
		project+'.zip',
		buildProd + '/js/app.js',
		buildProd + '/js/app.js.map',
		buildProd + '/js/vendors.js',
		buildProd + '/js/vendors.js.map',
		buildProd + '/css/style.css',
		buildProd + '/css/style.min.css',
		buildProd + '/css/style.css.map',
		buildProd + '/**/*.html',
...
gulp.task('watch', function(){
    ...
    gulp.watch(buildProd + '/API/taskAPI.php', browserSync.reload); 
